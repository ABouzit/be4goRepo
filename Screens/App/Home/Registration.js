...
export default class Registration extends Component {
  ...
  registerUser() {
      ...
      console.log("test");
      var url = Config.SERVER_URL+'/api/signup';
      ...
      axios.post(url, {
          ...
          .then( response => {
            ...
            if(response.data == "Vous etes bien inscrit") {
                this.loginUser();

            }
            else if(response.data == "Email already exists"){
                console.log("reeeeeeeeeeespo" + response.data);
                Alert.alert("L'adresse mail est déjà utilisér")
            }
            else if(response.data == "Please provide email and password"){
                console.log("reeeeeeeeeeespo" + response.data);
                Alert.alert("Veuillez entrez l'email et le mot de passe");
            }
            else {
                Alert.alert("Vous n'avez pas été inscrit , veuillez réessayer")
            }
      ...
      else Alert.alert("Les mots de passe ne correspondent pas.")
    }
      ...
      <ImageBackground style={{ width: '100%', height: '100%' }} source={require('../img/backGroundIdentification.jpg')}>
          <View style={styles.cantainer}>
              <View style={styles.header2}>
                  <Image source={require('../img/inscription.jpg')} resizeMode={'stretch'} style={styles.buttonbackgroundImage} />
              ...
              <KeyboardAwareScrollView>
                  <View Style={styles.bodyfrom}>
                      ...
                      <View style={styles.sectionDestination}>
                        ...
                        <Text style={styles.styleText2}>Créez votre compte</Text>
                        ...
                        <View style={styles.inputView}>
                            <View style={styles.labNdIcon2}>
                                <Image source={require('../img/cadna.png')} style={{ height: 30, width: 30, marginRight: 5, }} />
                                <Text style={styles.labelStyle}>Répéter mot de passe</Text>
                            </View>
                            <TextInput
                                value={this.state.hebergement}
                                style={styles.inputStyle}
